...
def color_judge(card_imgs):
    ...
    for ck, card_img in enumerate(card_imgs):
        ...
        color = "no"
        if yellow * 2.2 >= card_img_count:  # 经验值：2
            color = "yellow"
        elif green * 3.1 >= card_img_count:  # 经验值：2.4, 京AD77972(3.03)
            color = "green"
        elif blue * 3.1 >= card_img_count:  # 经验值：2.3, 蒙B099X8(3.03)
            color = "blue"
...
def location(source_img):
    ...
    # 验证是基于区域面积和宽高比。车牌的宽高比大约是440/140=3.142857(西班牙车牌是520/110 = 4.727272)并有
